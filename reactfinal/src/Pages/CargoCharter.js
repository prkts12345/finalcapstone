    ...
    <div className="container my-auto">
        <div className="row">
          <div className="col-lg-10 mx-auto">
            <h1 className="text-uppercase">
              <strong style={mystyle}>Cargo Charter&nbsp;</strong>
            </h1>
          </div>
        </div>
        <div className="col-lg-8 mx-auto">
          <p
            ...
            Home / Aircraft Solutions / Cargo Charter
          </p>
        </div>
      </div>
    </header>
        ...
        <div className="row">
          <div className="col-md-6">
            ...
            <p style={{fontFamily: ['Open Sans', 'sansSerif']}}>
              We can assist you in transporting your cargo to accessible
              destinations. Chartering a plane is the quickest way to ship your
              cargo from point A to point B. This is best used for
              time-sensitive goods or equipment.<br /><br />Need a cargo
              charter? Speak with our sales team by calling +632 8854 0001 or<br /><br />
            </p>
            <Link
